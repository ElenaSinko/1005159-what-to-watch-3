...
const MovieCard = ({movieTitle, movieGenre, movieYear}) => {
...
const Main = (props) => {
  ...
  return <React.Fragment>
    <section className="movie-card">
      ...
      {movieTitles.map((movieTitle, i) => <MovieCard key={movieTitle + i} movieTitle={movieTitle} movieGenre={movieGenre} movieYear={movieYear} />)}
    </section>
